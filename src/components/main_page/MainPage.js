        ...
        <div className="wholeBox">
            <div className="searchBox">
                <div className="search">
                    <input type="text" className="searchBar" placeholder="원하는 의뢰를 찾아보세요!"></input>
                </div>
                <div className="categories">
                    <div id = "cat1" className="category" onClick={() => goToCategory(1)}>
                        <div className="catePic">
                            <img src={testImg} alt="파일 사진"  style={{ width: "100%", height: "70%" }}/>
                            <span>그림/일러스트</span>
                        </div>
                    </div>
                    <div id = "cat2" className="category"onClick={() => goToCategory(2)}>
                        <div className="catePic">
                        <img src={testImg} alt="파일 사진"  style={{ width: "100%", height: "70%" }}/>
                            <span>코딩</span>
                        </div>
                    </div>
                    <div id = "cat3" className="category" onClick={() => goToCategory(3)}>
                        <div className="catePic">
                        <img src={testImg} alt="파일 사진"  style={{ width: "100%", height: "70%" }}/>
                            <span>음악/작곡</span>
                        </div>
                    </div>
                    <div id = "cat4" className="category" onClick={() => goToCategory(4)}>
                        <div className="catePic">
                        <img src={testImg} alt="파일 사진"  style={{ width: "100%", height: "70%" }}/>
                            <span>물품 제작</span>
                        </div>
                    </div>
                    <div id = "cat5" className="category" onClick={() => goToCategory(5)}>
                        <div className="catePic">
                        <img src={testImg} alt="파일 사진"  style={{ width: "100%", height: "70%" }}/>
                            <span>공연</span>
                        </div>
                    </div>
                    <div id = "cat6" className="category" onClick={() => goToCategory(6)}>
                        <div className="catePic">
                        <img src={testImg} alt="파일 사진"  style={{ width: "100%", height: "70%" }}/>
                            <span>기타</span>
                        </div>
